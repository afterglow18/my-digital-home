...
const ROSE      = "#E8B4C0";   // dusty pink — Spin It button colour
const ROSE_DARK = "#D09AAC";   // dusty pink mid
...
function RoseButton({
  ...
  return (
    <button
      ...
      style={{
        background: disabled ? '#D09AAC' : 'linear-gradient(to bottom, #E8B4C0, #D09AAC)',
