...
const ROSE       = "#E8B4C0";   // dusty pink light (Spin It button top)
const ROSE_DARK  = "#D09AAC";   // dusty pink mid (Spin It button bottom / border)
const ROSE_LIGHT = "#FDF0F3";   // very light tint for selected card bg
const ROSE_MID   = "#D09AAC";   // border / badge colour
    ...
    >
      ...
      >
        <button
          ...
          style={{
            background: status === "pending" ? "#D09AAC" : "linear-gradient(to bottom, #E8B4C0, #D09AAC)",
